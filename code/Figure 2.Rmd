...
ggplot(data = total_df_tidy, aes(x = activity, y = counts)) +
  ...
  geom_text(aes("Aquaculture", 82,label = "n=80", hjust= .5), size = 3) + # n values from sums df
  geom_text(aes("Tidal", 49,label = "n=47", hjust= .5), size = 3) +
  geom_text(aes("Wave", 87,label = "n=85", hjust= .5), size = 3) +
  geom_text(aes("Wind", 118,label = "n=116", hjust= .5), size = 3) +
  geom_text(aes("Other", 68,label = "n=66", hjust= .5), size = 3)
