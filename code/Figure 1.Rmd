...
## slope here is 0.9361 with an r^2 value of 0.769
# "If everything else stays constant, on average we would except an increase of .9361 co-location publications per year" and 76.9% of the variants are explained by this model
...
# "If everything else stays constant, on average we would except an increase of 2.8 co-location publications per year" and 93% of the variants are explained by this model
...
ggsave(filename = here("figures", "fig1.jpeg"), width = 8, height = 4, units = "in")
